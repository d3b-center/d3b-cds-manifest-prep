...
@click.option(
    "--cache_dir",
    type=click.Path(
        exists=False, dir_okay=True, file_okay=False, path_type=Path
    ),
    required=True,
    default=cache_default_dir,
    show_default=True,
    help="Directory to place cache files",
)
@click.option(
    "--build_excel/--dont_build_excel",
    default=True,
    show_default=True,
    help="Flag to build the excel output. If set to False, only build the files"
    "generated by each generator step.",
)
